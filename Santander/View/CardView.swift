                ...
                VStack {
                    ...
                    if !cardClosed{
                        VStack(alignment: .leading){
                            Text("Santander SX").font(.openSansBold(size: 18)).kerning(0.18).foregroundColor(.white)
                        ...
                        VStack(alignment: .leading) {
                            ...
                            VStack(alignment: .center) {
                                Rectangle()
                                    ...
                                    .cornerRadius(75)
                                Text("Ver Extrato").font(.openSansSemiBold(size: 18)).kerning(0.18).foregroundColor(.white).padding(.top, .zero)
                            }
                            .padding(.top, 8.0)
                        }
                    }
